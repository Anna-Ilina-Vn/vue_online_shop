<template>
  ...
  <div class='v-footer'>
    <router-link :to="{name: 'mainPage'}">
      <div class="img"><img src="https://pbs.twimg.com/profile_images/1317252331063418880/BH47wn01_400x400.jpg" alt=""></div>
    </router-link>
    ...
    <div class="contacts">
        ...
        <a href="tel:123-456-7890">123-456-7890</a></div>
        <div>
        <i class="material-icons">mail</i>
        <a href="mailto:anna-ilina_vn@ukr.net">anna-ilina_vn@ukr.net</a></div>
    </div>
    <div class="modal-footer">
      ...
      <div class="email-box">
        ...
        <div><span class="material-icons"><i>
        send</i>
        </span></div>
      </div>
    </div>
